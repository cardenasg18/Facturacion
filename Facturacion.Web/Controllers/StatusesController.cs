...
namespace Facturacion.Web.Controllers
{
    public class StatusesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StatusId,StatusOf")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusId,StatusOf")] Status status)
        {
