...
namespace Facturacion.Web.Controllers
{
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SellerId,SellerName,Number,Email")] Seller seller)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SellerId,SellerName,Number,Email")] Seller seller)
        {
