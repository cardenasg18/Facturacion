...
namespace Facturacion.Web.Migrations
{
    ...
    [Migration("20201208213531_reservacionfix")]
    partial class reservacionfix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facturacion.Web.Models.Chair", b =>
                {
            ...
            modelBuilder.Entity("Facturacion.Web.Models.Product", b =>
                {
                    b.Property<int>("ProductiD")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Facturacion.Web.Models.Usuario", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Facturacion.Web.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("Facturacion.Web.Models.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("Facturacion.Web.Models.PurchaseOrder", b =>
                {
                    b.HasOne("Facturacion.Web.Models.Chair", "Chair")
